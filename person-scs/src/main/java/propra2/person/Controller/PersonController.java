...
public class PersonController {
    ...
    public PersonController(ProjektRepository projektRepository, PersonRepository personRepository, EventRepository eventRepository) {
    ...
    @GetMapping("/add")
    public String addToDatabase(@RequestParam(value = "vorname") String vorname,
                                @RequestParam(value = "nachname") String nachname,
                                @RequestParam(value = "jahreslohn") String jahreslohn,
                                @RequestParam(value = "kontakt") String kontaktdaten,
                                @RequestParam(value = "skills") String[] skills,
                                @RequestParam(value = "vergangeneProjekte") Long[] vergangeneProjekte,
                                Model model) {
